...
export const headgear = {
  /** Bandana (Blue) */
  "bandanna_blu": "H_Bandanna_blu",
  /** Bandana (Woodland) */
  "bandanna_camo": "H_Bandanna_camo",
  /** Bandana (Coyote) */
  "bandanna_cbr": "H_Bandanna_cbr",
  /** Bandana (Black) */
  "bandanna_gry": "H_Bandanna_gry",
  /** Bandana (Khaki) */
  "bandanna_khk": "H_Bandanna_khk",
  /** Bandana (Headset) */
  "bandanna_khk_hs": "H_Bandanna_khk_hs",
  /** Bandana (MTP) */
  "bandanna_mcamo": "H_Bandanna_mcamo",
  /** Bandana (Sand) */
  "bandanna_sand": "H_Bandanna_sand",
  /** Bandana (Sage) */
  "bandanna_sgg": "H_Bandanna_sgg",
  /** Bandana (Surfer) */
  "bandanna_surfer": "H_Bandanna_surfer",
  /** Bandana (Surfer, Black) */
  "bandanna_surfer_blk": "H_Bandanna_surfer_blk",
  /** Bandana (Surfer, Green) */
  "bandanna_surfer_grn": "H_Bandanna_surfer_grn",
  /** Bandana Mask (Black) */
  "bandmask_blk": "H_BandMask_blk",
  /** Bandana Mask (Demon) */
  "bandmask_demon": "H_BandMask_demon",
  /** Bandana Mask (Khaki) */
  "bandmask_khk": "H_BandMask_khk",
  /** Bandana Mask (Reaper) */
  "bandmask_reaper": "H_BandMask_reaper",
  /** Beret [NATO] */
  "beret_02": "H_Beret_02",
  /** Beret (Black) */
  "beret_blk": "H_Beret_blk",
  /** Beret (Police) */
  "beret_blk_police": "H_Beret_blk_POLICE",
  /** Beret (SAS) */
  "beret_brn_sf": "H_Beret_brn_SF",
  /** Beret [NATO] (Colonel) */
  "beret_colonel": "H_Beret_Colonel",
  /** Beret (Red) [CSAT] */
  "beret_csat_01_f": "H_Beret_CSAT_01_F",
  /** Beret [LDF] */
  "beret_eaf_01_f": "H_Beret_EAF_01_F",
  /** Beret (Gendarmerie) */
  "beret_gen_f": "H_Beret_gen_F",
  /** Beret (Green) */
  "beret_grn": "H_Beret_grn",
  /** Beret (SF) */
  "beret_grn_sf": "H_Beret_grn_SF",
  /** Beret [CSAT] */
  "beret_ocamo": "H_Beret_ocamo",
  /** Beret (Red) */
  "beret_red": "H_Beret_red",
  /** Booniehat [AAF] */
  "booniehat_dgtl": "H_Booniehat_dgtl",
  /** Booniehat (Dirty) */
  "booniehat_dirty": "H_Booniehat_dirty",
  /** Booniehat [LDF] */
  "booniehat_eaf": "H_Booniehat_eaf",
  /** Booniehat (Green) */
  "booniehat_grn": "H_Booniehat_grn",
  /** Booniehat (Khaki) */
  "booniehat_indp": "H_Booniehat_indp",
  /** Booniehat (Khaki) */
  "booniehat_khk": "H_Booniehat_khk",
  /** Booniehat (Headset) */
  "booniehat_khk_hs": "H_Booniehat_khk_hs",
  /** Booniehat (MTP) */
  "booniehat_mcamo": "H_Booniehat_mcamo",
  /** Booniehat (Green) */
  "booniehat_mgrn": "H_Booniehat_mgrn",
  /** Booniehat (Olive) */
  "booniehat_oli": "H_Booniehat_oli",
  /** Booniehat (Taiga) */
  "booniehat_taiga": "H_Booniehat_taiga",
  /** Booniehat (Sand) */
  "booniehat_tan": "H_Booniehat_tan",
  /** Booniehat (Tropic) */
  "booniehat_tna_f": "H_Booniehat_tna_F",
  /** Booniehat (Woodland) */
  "booniehat_wdl": "H_Booniehat_wdl",
  /** Cap (Black) [IDAP] */
  "cap_black_idap_f": "H_Cap_Black_IDAP_F",
  /** Cap (Black) */
  "cap_blk": "H_Cap_blk",
  /** Cap (CMMG) */
  "cap_blk_cmmg": "H_Cap_blk_CMMG",
  /** Cap (ION) */
  "cap_blk_ion": "H_Cap_blk_ION",
  /** Cap [AAF] */
  "cap_blk_raven": "H_Cap_blk_Raven",
  /** Cap (Black) */
  "cap_blk_syndikat_f": "H_Cap_blk_Syndikat_F",
  /** Cap (Blue) */
  "cap_blu": "H_Cap_blu",
  /** Cap [OPFOR] */
  "cap_brn_specops": "H_Cap_brn_SPECOPS",
  /** Cap (Green) */
  "cap_grn": "H_Cap_grn",
  /** Cap (BI) */
  "cap_grn_bi": "H_Cap_grn_BI",
  /** Cap (Green) */
  "cap_grn_syndikat_f": "H_Cap_grn_Syndikat_F",
  /** Rangemaster Cap */
  "cap_headphones": "H_Cap_headphones",
  /** Cap (UK) */
  "cap_khaki_specops_uk": "H_Cap_khaki_specops_UK",
  /** Cap (Lyfe) */
  "cap_lyfe": "H_Cap_Lyfe",
  /** Cap (Malden Tours) */
  "cap_maldentours": "H_Cap_MaldenTours",
  /** Marshal Cap */
  "cap_marshal": "H_Cap_marshal",
  /** Cap (Olive) */
  "cap_oli": "H_Cap_oli",
  /** Cap (Olive, Headset) */
  "cap_oli_hs": "H_Cap_oli_hs",
  /** Cap (Olive) */
  "cap_oli_syndikat_f": "H_Cap_oli_Syndikat_F",
  /** Cap (Orange) [IDAP] */
  "cap_orange_idap_f": "H_Cap_Orange_IDAP_F",
  /** Cap (Police) */
  "cap_police": "H_Cap_police",
  /** Cap (Press) */
  "cap_press": "H_Cap_press",
  /** Cap (Red) */
  "cap_red": "H_Cap_red",
  /** Cap (Surfer) */
  "cap_surfer": "H_Cap_surfer",
  /** Cap (Tan) */
  "cap_tan": "H_Cap_tan",
  /** Cap (US MTP) */
  "cap_tan_specops_us": "H_Cap_tan_specops_US",
  /** Cap (Tan) */
  "cap_tan_syndikat_f": "H_Cap_tan_Syndikat_F",
  /** Cap (US Black) */
  "cap_usblack": "H_Cap_usblack",
  /** Cap (White) [IDAP] */
  "cap_white_idap_f": "H_Cap_White_IDAP_F",
  /** Hard Hat (Black) */
  "construction_basic_black_f": "H_Construction_basic_black_F",
  /** Hard Hat (Orange) */
  "construction_basic_orange_f": "H_Construction_basic_orange_F",
  /** Hard Hat (Red) */
  "construction_basic_red_f": "H_Construction_basic_red_F",
  /** Hard Hat (Vrana) */
  "construction_basic_vrana_f": "H_Construction_basic_vrana_F",
  /** Hard Hat (White) */
  "construction_basic_white_f": "H_Construction_basic_white_F",
  /** Hard Hat (Yellow) */
  "construction_basic_yellow_f": "H_Construction_basic_yellow_F",
  /** Hard Hat (Black, Ear Protectors) */
  "construction_earprot_black_f": "H_Construction_earprot_black_F",
  /** Hard Hat (Orange, Ear Protectors) */
  "construction_earprot_orange_f": "H_Construction_earprot_orange_F",
  /** Hard Hat (Red, Ear Protectors) */
  "construction_earprot_red_f": "H_Construction_earprot_red_F",
  /** Hard Hat (Vrana, Ear Protectors) */
  "construction_earprot_vrana_f": "H_Construction_earprot_vrana_F",
  /** Hard Hat (White, Ear Protectors) */
  "construction_earprot_white_f": "H_Construction_earprot_white_F",
  /** Hard Hat (Yellow, Ear Protectors) */
  "construction_earprot_yellow_f": "H_Construction_earprot_yellow_F",
  /** Hard Hat (Black, Headset) */
  "construction_headset_black_f": "H_Construction_headset_black_F",
  /** Hard Hat (Orange, Headset) */
  "construction_headset_orange_f": "H_Construction_headset_orange_F",
  /** Hard Hat (Red, Headset) */
  "construction_headset_red_f": "H_Construction_headset_red_F",
  /** Hard Hat (Vrana, Headset) */
  "construction_headset_vrana_f": "H_Construction_headset_vrana_F",
  /** Hard Hat (White, Headset) */
  "construction_headset_white_f": "H_Construction_headset_white_F",
  /** Hard Hat (Yellow, Headset) */
  "construction_headset_yellow_f": "H_Construction_headset_yellow_F",
  /** Heli Crew Helmet [NATO] */
  "crewhelmetheli_b": "H_CrewHelmetHeli_B",
  /** Heli Crew Helmet [AAF] */
  "crewhelmetheli_i": "H_CrewHelmetHeli_I",
  /** Heli Crew Helmet [LDF] */
  "crewhelmetheli_i_e": "H_CrewHelmetHeli_I_E",
  /** Heli Crew Helmet [CSAT] */
  "crewhelmetheli_o": "H_CrewHelmetHeli_O",
  /** Ear Protectors (Black) */
  "earprotectors_black_f": "H_EarProtectors_black_F",
  /** Ear Protectors (Orange) */
  "earprotectors_orange_f": "H_EarProtectors_orange_F",
  /** Ear Protectors (Red) */
  "earprotectors_red_f": "H_EarProtectors_red_F",
  /** Ear Protectors (White) */
  "earprotectors_white_f": "H_EarProtectors_white_F",
  /** Ear Protectors (Yellow) */
  "earprotectors_yellow_f": "H_EarProtectors_yellow_F",
  /** Hat (Blue) */
  "hat_blue": "H_Hat_blue",
  /** Hat (Brown) */
  "hat_brown": "H_Hat_brown",
  /** Hat (Camo) */
  "hat_camo": "H_Hat_camo",
  /** Hat (Checker) */
  "hat_checker": "H_Hat_checker",
  /** Hat (Grey) */
  "hat_grey": "H_Hat_grey",
  /** Safari Hat (Olive) */
  "hat_safari_olive_f": "H_Hat_Safari_olive_F",
  /** Safari Hat (Sand) */
  "hat_safari_sand_f": "H_Hat_Safari_sand_F",
  /** Hat (Tan) */
  "hat_tan": "H_Hat_tan",
  /** Tin Foil Hat */
  "hat_tinfoil_f": "H_Hat_Tinfoil_F",
  /** Head Bandage (Severe) */
  "headbandage_bloody_f": "H_HeadBandage_bloody_F",
  /** Head Bandage (Clean) */
  "headbandage_clean_f": "H_HeadBandage_clean_F",
  /** Head Bandage (Moderate) */
  "headbandage_stained_f": "H_HeadBandage_stained_F",
  /** Headset (Black) */
  "headset_black_f": "H_HeadSet_black_F",
  /** Headset (Orange) */
  "headset_orange_f": "H_HeadSet_orange_F",
  /** Headset (Red) */
  "headset_red_f": "H_HeadSet_red_F",
  /** Headset (White) */
  "headset_white_f": "H_HeadSet_white_F",
  /** Headset (Yellow) */
  "headset_yellow_f": "H_HeadSet_yellow_F",
  /** Combat Helmet (Kerry) */
  "helmet_kerry": "H_Helmet_Kerry",
  /** Skate Helmet */
  "helmet_skate": "H_Helmet_Skate",
  /** Avenger Helmet (Cover B) */
  "helmetaggressor_cover_f": "H_HelmetAggressor_cover_F",
  /** Avenger Helmet (Cover T) */
  "helmetaggressor_cover_taiga_f": "H_HelmetAggressor_cover_taiga_F",
  /** Avenger Helmet */
  "helmetaggressor_f": "H_HelmetAggressor_F",
  /** Combat Helmet */
  "helmetb": "H_HelmetB",
  /** Combat Helmet (Black) */
  "helmetb_black": "H_HelmetB_black",
  /** Combat Helmet (Camo) */
  "helmetb_camo": "H_HelmetB_camo",
  /** Combat Helmet (Desert) */
  "helmetb_desert": "H_HelmetB_desert",
  /** Enhanced Combat Helmet (Tropic) */
  "helmetb_enh_tna_f": "H_HelmetB_Enh_tna_F",
  /** Combat Helmet (Grass) */
  "helmetb_grass": "H_HelmetB_grass",
  /** Light Combat Helmet */
  "helmetb_light": "H_HelmetB_light",
  /** Light Combat Helmet (Black) */
  "helmetb_light_black": "H_HelmetB_light_black",
  /** Light Combat Helmet (Desert) */
  "helmetb_light_desert": "H_HelmetB_light_desert",
  /** Light Combat Helmet (Grass) */
  "helmetb_light_grass": "H_HelmetB_light_grass",
  /** Light Combat Helmet (Sand) */
  "helmetb_light_sand": "H_HelmetB_light_sand",
  /** Light Combat Helmet (Snakeskin) */
  "helmetb_light_snakeskin": "H_HelmetB_light_snakeskin",
  /** Light Combat Helmet (Tropic) */
  "helmetb_light_tna_f": "H_HelmetB_Light_tna_F",
  /** Light Combat Helmet (Woodland) */
  "helmetb_light_wdl": "H_HelmetB_light_wdl",
  /** Combat Helmet (Spraypaint) */
  "helmetb_paint": "H_HelmetB_paint",
  /** Combat Helmet (Black) */
  "helmetb_plain_blk": "H_HelmetB_plain_blk",
  /** Combat Helmet (Camo) */
  "helmetb_plain_mcamo": "H_HelmetB_plain_mcamo",
  /** Combat Helmet (Woodland) */
  "helmetb_plain_wdl": "H_HelmetB_plain_wdl",
  /** Combat Helmet (Sand) */
  "helmetb_sand": "H_HelmetB_sand",
  /** Combat Helmet (Snakeskin) */
  "helmetb_snakeskin": "H_HelmetB_snakeskin",
  /** Stealth Combat Helmet (Arid) */
  "helmetb_ti_arid_f": "H_HelmetB_TI_arid_F",
  /** Stealth Combat Helmet */
  "helmetb_ti_tna_f": "H_HelmetB_TI_tna_F",
  /** Combat Helmet (Tropic) */
  "helmetb_tna_f": "H_HelmetB_tna_F",
  /** Crew Helmet [NATO] */
  "helmetcrew_b": "H_HelmetCrew_B",
  /** Crew Helmet [AAF] */
  "helmetcrew_i": "H_HelmetCrew_I",
  /** Crew Helmet [LDF] */
  "helmetcrew_i_e": "H_HelmetCrew_I_E",
  /** Crew Helmet [CSAT] */
  "helmetcrew_o": "H_HelmetCrew_O",
  /** Crew Helmet (Green Hex) [CSAT] */
  "helmetcrew_o_ghex_f": "H_HelmetCrew_O_ghex_F",
  /** Advanced Modular Helmet (Chops) */
  "helmethbk_chops_f": "H_HelmetHBK_chops_F",
  /** Advanced Modular Helmet (Ear Protectors) */
  "helmethbk_ear_f": "H_HelmetHBK_ear_F",
  /** Advanced Modular Helmet (Olive) */
  "helmethbk_f": "H_HelmetHBK_F",
  /** Advanced Modular Helmet */
  "helmethbk_headset_f": "H_HelmetHBK_headset_F",
  /** Modular Helmet */
  "helmetia": "H_HelmetIA",
  /** MICH2 (Camo) */
  "helmetia_camo": "H_HelmetIA_camo",
  /** MICH (Camo) */
  "helmetia_net": "H_HelmetIA_net",
  /** Defender Helmet (Green Hex) */
  "helmetleadero_ghex_f": "H_HelmetLeaderO_ghex_F",
  /** Defender Helmet (Hex) */
  "helmetleadero_ocamo": "H_HelmetLeaderO_ocamo",
  /** Defender Helmet (Urban) */
  "helmetleadero_oucamo": "H_HelmetLeaderO_oucamo",
  /** Protector Helmet (Green Hex) */
  "helmeto_ghex_f": "H_HelmetO_ghex_F",
  /** Protector Helmet (Hex) */
  "helmeto_ocamo": "H_HelmetO_ocamo",
  /** Protector Helmet (Urban) */
  "helmeto_oucamo": "H_HelmetO_oucamo",
  /** Special Purpose Helmet (Green Hex) */
  "helmeto_vipersp_ghex_f": "H_HelmetO_ViperSP_ghex_F",
  /** Special Purpose Helmet (Hex) */
  "helmeto_vipersp_hex_f": "H_HelmetO_ViperSP_hex_F",
  /** Enhanced Combat Helmet */
  "helmetspecb": "H_HelmetSpecB",
  /** Enhanced Combat Helmet (Black) */
  "helmetspecb_blk": "H_HelmetSpecB_blk",
  /** Enhanced Combat Helmet (Grass) */
  "helmetspecb_paint1": "H_HelmetSpecB_paint1",
  /** Enhanced Combat Helmet (Desert) */
  "helmetspecb_paint2": "H_HelmetSpecB_paint2",
  /** Enhanced Combat Helmet (Sand) */
  "helmetspecb_sand": "H_HelmetSpecB_sand",
  /** Enhanced Combat Helmet (Snakeskin) */
  "helmetspecb_snakeskin": "H_HelmetSpecB_snakeskin",
  /** Enhanced Combat Helmet (Woodland) */
  "helmetspecb_wdl": "H_HelmetSpecB_wdl",
  /** Assassin Helmet (Black) */
  "helmetspeco_blk": "H_HelmetSpecO_blk",
  /** Assassin Helmet (Green Hex) */
  "helmetspeco_ghex_f": "H_HelmetSpecO_ghex_F",
  /** Assassin Helmet (Hex) */
  "helmetspeco_ocamo": "H_HelmetSpecO_ocamo",
  /** Military Cap (Blue) */
  "milcap_blue": "H_MilCap_blue",
  /** Military Cap [AAF] */
  "milcap_dgtl": "H_MilCap_dgtl",
  /** Military Cap [LDF] */
  "milcap_eaf": "H_MilCap_eaf",
  /** Military Cap (Gendarmerie) */
  "milcap_gen_f": "H_MilCap_gen_F",
  /** Military Cap (Green Hex) */
  "milcap_ghex_f": "H_MilCap_ghex_F",
  /** Military Cap (Green) */
  "milcap_grn": "H_MilCap_grn",
  /** Military Cap (Grey) */
  "milcap_gry": "H_MilCap_gry",
  /** Military Cap (MTP) */
  "milcap_mcamo": "H_MilCap_mcamo",
  /** Military Cap (Hex) */
  "milcap_ocamo": "H_MilCap_ocamo",
  /** Military Cap (Urban) */
  "milcap_oucamo": "H_MilCap_oucamo",
  /** Military Cap (Russia) */
  "milcap_rucamo": "H_MilCap_rucamo",
  /** Military Cap (Taiga) */
  "milcap_taiga": "H_MilCap_taiga",
  /** Military Cap (Tropic) */
  "milcap_tna_f": "H_MilCap_tna_F",
  /** Military Cap (Woodland) */
  "milcap_wdl": "H_MilCap_wdl",
  /** Parade Cap [AAF] */
  "paradedresscap_01_aaf_f": "H_ParadeDressCap_01_AAF_F",
  /** Parade Cap [CSAT] */
  "paradedresscap_01_csat_f": "H_ParadeDressCap_01_CSAT_F",
  /** Parade Cap [LDF] */
  "paradedresscap_01_ldf_f": "H_ParadeDressCap_01_LDF_F",
  /** Parade Cap [US] */
  "paradedresscap_01_us_f": "H_ParadeDressCap_01_US_F",
  /** Basic Helmet (Black) */
  "pasgt_basic_black_f": "H_PASGT_basic_black_F",
  /** Basic Helmet (Blue) */
  "pasgt_basic_blue_f": "H_PASGT_basic_blue_F",
  /** Press Helmet */
  "pasgt_basic_blue_press_f": "H_PASGT_basic_blue_press_F",
  /** Basic Helmet (Olive) */
  "pasgt_basic_olive_f": "H_PASGT_basic_olive_F",
  /** Basic Helmet (White) */
  "pasgt_basic_white_f": "H_PASGT_basic_white_F",
  /** Press Helmet (Neck Protection) */
  "pasgt_neckprot_blue_press_f": "H_PASGT_neckprot_blue_press_F",
  /** Pilot Helmet [NATO] */
  "pilothelmetfighter_b": "H_PilotHelmetFighter_B",
  /** Pilot Helmet [AAF] */
  "pilothelmetfighter_i": "H_PilotHelmetFighter_I",
  /** Pilot Helmet [LDF] */
  "pilothelmetfighter_i_e": "H_PilotHelmetFighter_I_E",
  /** Pilot Helmet [CSAT] */
  "pilothelmetfighter_o": "H_PilotHelmetFighter_O",
  /** Heli Pilot Helmet [NATO] */
  "pilothelmetheli_b": "H_PilotHelmetHeli_B",
  /** Heli Pilot Helmet [AAF] */
  "pilothelmetheli_i": "H_PilotHelmetHeli_I",
  /** Heli Pilot Helmet [LDF] */
  "pilothelmetheli_i_e": "H_PilotHelmetHeli_I_E",
  /** Heli Pilot Helmet [CSAT] */
  "pilothelmetheli_o": "H_PilotHelmetHeli_O",
  /** Racing Helmet (Black) */
  "racinghelmet_1_black_f": "H_RacingHelmet_1_black_F",
  /** Racing Helmet (Blue) */
  "racinghelmet_1_blue_f": "H_RacingHelmet_1_blue_F",
  /** Racing Helmet (Fuel) */
  "racinghelmet_1_f": "H_RacingHelmet_1_F",
  /** Racing Helmet (Green) */
  "racinghelmet_1_green_f": "H_RacingHelmet_1_green_F",
  /** Racing Helmet (Orange) */
  "racinghelmet_1_orange_f": "H_RacingHelmet_1_orange_F",
  /** Racing Helmet (Red) */
  "racinghelmet_1_red_f": "H_RacingHelmet_1_red_F",
  /** Racing Helmet (White) */
  "racinghelmet_1_white_f": "H_RacingHelmet_1_white_F",
  /** Racing Helmet (Yellow) */
  "racinghelmet_1_yellow_f": "H_RacingHelmet_1_yellow_F",
  /** Racing Helmet (Bluking) */
  "racinghelmet_2_f": "H_RacingHelmet_2_F",
  /** Racing Helmet (Redstone) */
  "racinghelmet_3_f": "H_RacingHelmet_3_F",
  /** Racing Helmet (Vrana) */
  "racinghelmet_4_f": "H_RacingHelmet_4_F",
  /** Shemag mask (Khaki) */
  "shemag_khk": "H_Shemag_khk",
  /** Shemag (Olive) */
  "shemag_olive": "H_Shemag_olive",
  /** Shemag (Olive, Headset) */
  "shemag_olive_hs": "H_Shemag_olive_hs",
  /** Shemag mask (Tan) */
  "shemag_tan": "H_Shemag_tan",
  /** Shemag (White) */
  "shemagopen_khk": "H_ShemagOpen_khk",
  /** Shemag (Tan) */
  "shemagopen_tan": "H_ShemagOpen_tan",
  /** Straw Hat */
  "strawhat": "H_StrawHat",
  /** Straw Hat (Dark) */
  "strawhat_dark": "H_StrawHat_dark",
  /** Crew Helmet (Soft) [CSAT] */
  "tank_black_f": "H_Tank_black_F",
  /** Crew Helmet (Soft) [LDF] */
  "tank_eaf_f": "H_Tank_eaf_F",
  /** Black Turban */
  "turbano_blk": "H_TurbanO_blk",
  /** Beanie */
  "watchcap_blk": "H_Watchcap_blk",
  /** Beanie (Green) */
  "watchcap_camo": "H_Watchcap_camo",
  /** Beanie (Coyote) */
  "watchcap_cbr": "H_Watchcap_cbr",
  /** Beanie (Khaki) */
  "watchcap_khk": "H_Watchcap_khk",
  /** Beanie (Sage) */
  "watchcap_sgg": "H_Watchcap_sgg",
  /** Wireless Earpiece */
  "wirelessearpiece_f": "H_WirelessEarpiece_F",
} as const;
export type HeadgearClassName = typeof headgear[keyof typeof headgear];

export const uniforms = {
  /** Underwear 5 */
  "antigonabody": "U_AntigonaBody",
  /** Underwear 4 */
  "attisbody": "U_AttisBody",
  /** CBRN Suit (MTP) [NATO] */
  "b_cbrn_suit_01_mtp_f": "U_B_CBRN_Suit_01_MTP_F",
  /** CBRN Suit (Tropic) [NATO] */
  "b_cbrn_suit_01_tropic_f": "U_B_CBRN_Suit_01_Tropic_F",
  /** CBRN Suit (Woodland) [NATO] */
  "b_cbrn_suit_01_wdl_f": "U_B_CBRN_Suit_01_Wdl_F",
  /** Combat Fatigues (MTP) */
  "b_combatuniform_mcam": "U_B_CombatUniform_mcam",
  /** Combat Fatigues (MTP) (Tee) */
  "b_combatuniform_mcam_tshirt": "U_B_CombatUniform_mcam_tshirt",
  /** Recon Fatigues (MTP) */
  "b_combatuniform_mcam_vest": "U_B_CombatUniform_mcam_vest",
  /** Combat Fatigues (Woodland) */
  "b_combatuniform_mcam_wdl_f": "U_B_CombatUniform_mcam_wdl_f",
  /** Worn Combat Fatigues (MTP) */
  "b_combatuniform_mcam_worn": "U_B_CombatUniform_mcam_worn",
  /** Combat Fatigues (MTP) */
  "b_combatuniform_sgg": "U_B_CombatUniform_sgg",
  /** Combat Fatigues (MTP) (Tee) */
  "b_combatuniform_sgg_tshirt": "U_B_CombatUniform_sgg_tshirt",
  /** Recon Fatigues (MTP) */
  "b_combatuniform_sgg_vest": "U_B_CombatUniform_sgg_vest",
  /** Combat Fatigues (Woodland, Tee) */
  "b_combatuniform_tshirt_mcam_wdl_f": "U_B_CombatUniform_tshirt_mcam_wdL_f",
  /** Recon Fatigues (Woodland) */
  "b_combatuniform_vest_mcam_wdl_f": "U_B_CombatUniform_vest_mcam_wdl_f",
  /** Combat Fatigues (MTP) */
  "b_combatuniform_wdl": "U_B_CombatUniform_wdl",
  /** Combat Fatigues (MTP) (Tee) */
  "b_combatuniform_wdl_tshirt": "U_B_CombatUniform_wdl_tshirt",
  /** Recon Fatigues (MTP) */
  "b_combatuniform_wdl_vest": "U_B_CombatUniform_wdl_vest",
  /** CTRG Combat Uniform */
  "b_ctrg_1": "U_B_CTRG_1",
  /** CTRG Combat Uniform (Tee) */
  "b_ctrg_2": "U_B_CTRG_2",
  ...
  "b_ctrg_3": "U_B_CTRG_3",
  /** CTRG Stealth Uniform (Tee, Arid) */
  "b_ctrg_soldier_2_arid_f": "U_B_CTRG_Soldier_2_Arid_F",
  /** CTRG Stealth Uniform (Tee) */
  "b_ctrg_soldier_2_f": "U_B_CTRG_Soldier_2_F",
  /** CTRG Stealth Uniform (Rolled-up, Arid) */
  "b_ctrg_soldier_3_arid_f": "U_B_CTRG_Soldier_3_Arid_F",
  /** CTRG Stealth Uniform (Rolled-up) */
  "b_ctrg_soldier_3_f": "U_B_CTRG_Soldier_3_F",
  /** CTRG Stealth Uniform (Arid) */
  "b_ctrg_soldier_arid_f": "U_B_CTRG_Soldier_Arid_F",
  /** CTRG Stealth Uniform */
  "b_ctrg_soldier_f": "U_B_CTRG_Soldier_F",
  /** CTRG Urban Uniform */
  "b_ctrg_soldier_urb_1_f": "U_B_CTRG_Soldier_urb_1_F",
  /** CTRG Urban Uniform (Tee) */
  "b_ctrg_soldier_urb_2_f": "U_B_CTRG_Soldier_urb_2_F",
  /** CTRG Urban Uniform (Rolled-up) */
  "b_ctrg_soldier_urb_3_f": "U_B_CTRG_Soldier_urb_3_F",
  /** Full Ghillie (Arid) [NATO] */
  "b_fullghillie_ard": "U_B_FullGhillie_ard",
  /** Full Ghillie (Lush) [NATO] */
  "b_fullghillie_lsh": "U_B_FullGhillie_lsh",
  /** Full Ghillie (Semi-Arid) [NATO] */
  "b_fullghillie_sard": "U_B_FullGhillie_sard",
  /** Paramilitary Garb (Jacket) */
  "b_g_captain_ivan_f": "U_B_G_Captain_Ivan_F",
  /** Gendarmerie Commander Uniform */
  "b_gen_commander_f": "U_B_GEN_Commander_F",
  /** Gendarmerie Uniform */
  "b_gen_soldier_f": "U_B_GEN_Soldier_F",
  /** Ghillie Suit [NATO] */
  "b_ghilliesuit": "U_B_GhillieSuit",
  /** Heli Pilot Coveralls [NATO] */
  "b_helipilotcoveralls": "U_B_HeliPilotCoveralls",
  /** Parade Uniform (Decorated) [US] */
  "b_paradeuniform_01_us_decorated_f": "U_B_ParadeUniform_01_US_decorated_F",
  /** Parade Uniform [US] */
  "b_paradeuniform_01_us_f": "U_B_ParadeUniform_01_US_F",
  /** Pilot Coveralls [NATO] */
  "b_pilotcoveralls": "U_B_PilotCoveralls",
  /** VR Suit [NATO] */
  "b_protagonist_vr": "U_B_Protagonist_VR",
  /** VR Entity Suit */
  "b_soldier_vr": "U_B_Soldier_VR",
  /** Specop Fatigues (Sage) */
  "b_specopsuniform_sgg": "U_B_SpecopsUniform_sgg",
  /** Survival Fatigues */
  "b_survival_uniform": "U_B_survival_uniform",
  /** Full Ghillie (Jungle) [NATO] */
  "b_t_fullghillie_tna_f": "U_B_T_FullGhillie_tna_F",
  /** Ghillie Suit (Tropic) [NATO] */
  "b_t_sniper_f": "U_B_T_Sniper_F",
  /** Combat Fatigues (Tropic, Tee) */
  "b_t_soldier_ar_f": "U_B_T_Soldier_AR_F",
  /** Combat Fatigues (Tropic) */
  "b_t_soldier_f": "U_B_T_Soldier_F",
  /** Recon Fatigues (Tropic) */
  "b_t_soldier_sl_f": "U_B_T_Soldier_SL_F",
  /** Wetsuit [NATO] */
  "b_wetsuit": "U_B_Wetsuit",
  /** Underwear */
  "basicbody": "U_BasicBody",
  /** Guerilla Garment */
  "bg_guerilla1_1": "U_BG_Guerilla1_1",
  /** Guerilla Garment (Olive) */
  "bg_guerilla1_2_f": "U_BG_Guerilla1_2_F",
  /** Guerilla Outfit (Plain, Dark) */
  "bg_guerilla2_1": "U_BG_Guerilla2_1",
  /** Guerilla Outfit (Pattern) */
  "bg_guerilla2_2": "U_BG_Guerilla2_2",
  /** Guerilla Outfit (Plain, Light) */
  "bg_guerilla2_3": "U_BG_Guerilla2_3",
  /** Guerilla Smocks */
  "bg_guerilla3_1": "U_BG_Guerilla3_1",
  /** Guerilla Smocks 1 */
  "bg_guerilla3_2": "U_BG_Guerilla3_2",
  /** Guerilla Apparel */
  "bg_guerrilla_6_1": "U_BG_Guerrilla_6_1",
  /** Guerilla Uniform */
  "bg_leader": "U_BG_leader",
  /** Casual Clothes (Art of War) */
  "c_arttshirt_01_v1_f": "U_C_ArtTShirt_01_v1_F",
  /** Casual Clothes (Drones) */
  "c_arttshirt_01_v2_f": "U_C_ArtTShirt_01_v2_F",
  /** Casual Clothes (Waltham Robotics) */
  "c_arttshirt_01_v3_f": "U_C_ArtTShirt_01_v3_F",
  /** Casual Clothes (Exhibition) */
  "c_arttshirt_01_v4_f": "U_C_ArtTShirt_01_v4_F",
  /** Casual Clothes (Robogeddon) */
  "c_arttshirt_01_v5_f": "U_C_ArtTShirt_01_v5_F",
  /** Casual Clothes (Abstract) */
  "c_arttshirt_01_v6_f": "U_C_ArtTShirt_01_v6_F",
  /** CBRN Suit (Blue) */
  "c_cbrn_suit_01_blue_f": "U_C_CBRN_Suit_01_Blue_F",
  /** CBRN Suit (White) */
  "c_cbrn_suit_01_white_f": "U_C_CBRN_Suit_01_White_F",
  /** Commoner Shorts */
  "c_commoner_shorts": "U_C_Commoner_shorts",
  /** Commoner Clothes 2 */
  "c_commoner1_1": "U_C_Commoner1_1",
  /** Commoner Clothes 2 */
  "c_commoner1_2": "U_C_Commoner1_2",
  /** Commoner Clothes 3 */
  "c_commoner1_3": "U_C_Commoner1_3",
  /** Commoner Clothes 4 */
  "c_commoner2_1": "U_C_Commoner2_1",
  /** Commoner Clothes 5 */
  "c_commoner2_2": "U_C_Commoner2_2",
  /** Commoner Clothes 6 */
  "c_commoner2_3": "U_C_Commoner2_3",
  /** Construction Coverall (Black) */
  "c_constructioncoverall_black_f": "U_C_ConstructionCoverall_Black_F",
  /** Construction Coverall (Blue) */
  "c_constructioncoverall_blue_f": "U_C_ConstructionCoverall_Blue_F",
  /** Construction Coverall (Red) */
  "c_constructioncoverall_red_f": "U_C_ConstructionCoverall_Red_F",
  /** Construction Coverall (Vrana) */
  "c_constructioncoverall_vrana_f": "U_C_ConstructionCoverall_Vrana_F",
  /** Driver Coverall (Fuel) */
  "c_driver_1": "U_C_Driver_1",
  /** Driver Coverall (Black) */
  "c_driver_1_black": "U_C_Driver_1_black",
  /** Driver Coverall (Blue) */
  "c_driver_1_blue": "U_C_Driver_1_blue",
  /** Driver Coverall (Green) */
  "c_driver_1_green": "U_C_Driver_1_green",
  /** Driver Coverall (Orange) */
  "c_driver_1_orange": "U_C_Driver_1_orange",
  /** Driver Coverall (Red) */
  "c_driver_1_red": "U_C_Driver_1_red",
  /** Driver Coverall (White) */
  "c_driver_1_white": "U_C_Driver_1_white",
  /** Driver Coverall (Yellow) */
  "c_driver_1_yellow": "U_C_Driver_1_yellow",
  /** Driver Coverall (Bluking) */
  "c_driver_2": "U_C_Driver_2",
  /** Driver Coverall (Redstone) */
  "c_driver_3": "U_C_Driver_3",
  /** Driver Coverall (Vrana) */
  "c_driver_4": "U_C_Driver_4",
  /** Looter Clothes (Leather Jacket) */
  "c_e_looterjacket_01_f": "U_C_E_LooterJacket_01_F",
  /** Farmer Clothes */
  "c_farmer": "U_C_Farmer",
  /** Fishing Clothes */
  "c_fisherman": "U_C_Fisherman",
  /** Fishing Overalls */
  "c_fishermanoveralls": "U_C_FishermanOveralls",
  /** Formal Suit (Black) */
  "c_formalsuit_01_black_f": "U_C_FormalSuit_01_black_F",
  /** Formal Suit (Blue) */
  "c_formalsuit_01_blue_f": "U_C_FormalSuit_01_blue_F",
  /** Formal Suit (Gray) */
  "c_formalsuit_01_gray_f": "U_C_FormalSuit_01_gray_F",
  /** Formal Suit (Khaki) */
  "c_formalsuit_01_khaki_f": "U_C_FormalSuit_01_khaki_F",
  /** Formal Suit (T-Shirt, Black) */
  "c_formalsuit_01_tshirt_black_f": "U_C_FormalSuit_01_tshirt_black_F",
  /** Formal Suit (T-Shirt, Gray) */
  "c_formalsuit_01_tshirt_gray_f": "U_C_FormalSuit_01_tshirt_gray_F",
  /** Hunting Clothes (Brown) */
  "c_hunterbody_brn": "U_C_HunterBody_brn",
  /** Hunting Clothes */
  "c_hunterbody_grn": "U_C_HunterBody_grn",
  /** Aid Worker Clothes (Cargo) [IDAP] */
  "c_idap_man_cargo_f": "U_C_IDAP_Man_cargo_F",
  /** Aid Worker Clothes (Polo) [IDAP] */
  "c_idap_man_casual_f": "U_C_IDAP_Man_casual_F",
  /** Aid Worker Clothes (Jeans) [IDAP] */
  "c_idap_man_jeans_f": "U_C_IDAP_Man_Jeans_F",
  /** Aid Worker Clothes (Polo, Shorts) [IDAP] */
  "c_idap_man_shorts_f": "U_C_IDAP_Man_shorts_F",
  /** Aid Worker Clothes (Tee) [IDAP] */
  "c_idap_man_tee_f": "U_C_IDAP_Man_Tee_F",
  /** Aid Worker Clothes (Tee, Shorts) [IDAP] */
  "c_idap_man_teeshorts_f": "U_C_IDAP_Man_TeeShorts_F",
  /** Journalist Clothes */
  "c_journalist": "U_C_Journalist",
  /** Casual Clothes (Navy) */
  "c_man_casual_1_f": "U_C_Man_casual_1_F",
  /** Casual Clothes (Navy) */
  "c_man_casual_1_sick_f": "U_C_Man_casual_1_sick_F",
  /** Casual Clothes (Blue) */
  "c_man_casual_2_f": "U_C_Man_casual_2_F",
  /** Casual Clothes (Blue) */
  "c_man_casual_2_sick_f": "U_C_Man_casual_2_sick_F",
  /** Casual Clothes (Green) */
  "c_man_casual_3_f": "U_C_Man_casual_3_F",
  /** Casual Clothes (Green) */
  "c_man_casual_3_sick_f": "U_C_Man_casual_3_sick_F",
  /** Summer Clothes (Sky) */
  "c_man_casual_4_f": "U_C_Man_casual_4_F",
  /** Summer Clothes (Sky) */
  "c_man_casual_4_sick_f": "U_C_Man_casual_4_sick_F",
  /** Summer Clothes (Yellow) */
  "c_man_casual_5_f": "U_C_Man_casual_5_F",
  /** Summer Clothes (Yellow) */
  "c_man_casual_5_sick_f": "U_C_Man_casual_5_sick_F",
  /** Summer Clothes (Red) */
  "c_man_casual_6_f": "U_C_Man_casual_6_F",
  /** Summer Clothes (Red) */
  "c_man_casual_6_sick_f": "U_C_Man_casual_6_sick_F",
  /** Sport Clothes (Beach) */
  "c_man_sport_1_f": "U_C_man_sport_1_F",
  /** Sport Clothes (Orange) */
  "c_man_sport_2_f": "U_C_man_sport_2_F",
  /** Sport Clothes (Orange) */
  "c_man_sport_2_sick_f": "U_C_man_sport_2_sick_F",
  /** Sport Clothes (Blue) */
  "c_man_sport_3_f": "U_C_man_sport_3_F",
  /** Mechanic Clothes */
  "c_mechanic_01_f": "U_C_Mechanic_01_F",
  /** Novak's Leisure Suit */
  "c_novak": "U_C_Novak",
  /** Paramedic Outfit */
  "c_paramedic_01_f": "U_C_Paramedic_01_F",
  /** Commoner Clothes (Blue) */
  "c_poloshirt_blue": "U_C_Poloshirt_blue",
  /** Commoner Clothes (Blue) */
  "c_poloshirt_blue_sick": "U_C_Poloshirt_blue_sick",
  /** Commoner Clothes (Burgundy) */
  "c_poloshirt_burgundy": "U_C_Poloshirt_burgundy",
  /** Commoner Clothes (Burgundy) */
  "c_poloshirt_burgundy_sick": "U_C_Poloshirt_burgundy_sick",
  /** Commoner Clothes (Red-White) */
  "c_poloshirt_redwhite": "U_C_Poloshirt_redwhite",
  /** Commoner Clothes (Red-White) */
  "c_poloshirt_redwhite_sick": "U_C_Poloshirt_redwhite_sick",
  /** Commoner Clothes (Salmon) */
  "c_poloshirt_salmon": "U_C_Poloshirt_salmon",
  /** Commoner Clothes (Striped) */
  "c_poloshirt_stripped": "U_C_Poloshirt_stripped",
  /** Commoner Clothes (Striped) */
  "c_poloshirt_stripped_sick": "U_C_Poloshirt_stripped_sick",
  /** Commoner Clothes (Tricolor) */
  "c_poloshirt_tricolour": "U_C_Poloshirt_tricolour",
  /** Worn Clothes */
  "c_poor_1": "U_C_Poor_1",
  /** Worn Clothes */
  "c_poor_2": "U_C_Poor_2",
  /** Worn Clothes */
  "c_poor_2_sick": "U_C_Poor_2_sick",
  /** Worn Shorts 1 */
  "c_poor_shorts_1": "U_C_Poor_shorts_1",
  /** Worn Shorts 2 */
  "c_poor_shorts_2": "U_C_Poor_shorts_2",
  /** Clerical Robes */
  "c_priestbody": "U_C_PriestBody",
  /** VR Suit [Civilians] */
  "c_protagonist_vr": "U_C_Protagonist_VR",
  /** Scavenger Clothes (Light) */
  "c_scavenger_1": "U_C_Scavenger_1",
  /** Scavenger Clothes (Dark) */
  "c_scavenger_2": "U_C_Scavenger_2",
  /** Scientist Clothes */
  "c_scientist": "U_C_Scientist",
  /** Surfer Outfit 1 */
  "c_shirtsurfer_shorts": "U_C_ShirtSurfer_shorts",
  /** VR Entity Suit */
  "c_soldier_vr": "U_C_Soldier_VR",
  /** Surfer Outfit 2 */
  "c_teesurfer_shorts_1": "U_C_TeeSurfer_shorts_1",
  /** Surfer Outfit 3 */
  "c_teesurfer_shorts_2": "U_C_TeeSurfer_shorts_2",
  /** Farmer Outfit */
  "c_uniform_farmer_01_f": "U_C_Uniform_Farmer_01_F",
  /** Scientist Outfit (Formal, White) */
  "c_uniform_scientist_01_f": "U_C_Uniform_Scientist_01_F",
  /** Scientist Outfit (Formal, Blue) */
  "c_uniform_scientist_01_formal_f": "U_C_Uniform_Scientist_01_formal_F",
  /** Scientist Outfit (Informal, Black) */
  "c_uniform_scientist_02_f": "U_C_Uniform_Scientist_02_F",
  /** Scientist Outfit (Informal, Red) */
  "c_uniform_scientist_02_formal_f": "U_C_Uniform_Scientist_02_formal_F",
  /** Worker Coveralls */
  "c_workercoveralls": "U_C_WorkerCoveralls",
  /** Worker Clothes */
  "c_workeroveralls": "U_C_WorkerOveralls",
  /** Competitor Suit */
  "competitor": "U_Competitor",
  /** Bandit Clothes (Polo Shirt) */
  "i_c_soldier_bandit_1_f": "U_I_C_Soldier_Bandit_1_F",
  /** Bandit Clothes (Skull) */
  "i_c_soldier_bandit_2_f": "U_I_C_Soldier_Bandit_2_F",
  /** Bandit Clothes (Tee) */
  "i_c_soldier_bandit_3_f": "U_I_C_Soldier_Bandit_3_F",
  /** Bandit Clothes (Checkered) */
  "i_c_soldier_bandit_4_f": "U_I_C_Soldier_Bandit_4_F",
  /** Bandit Clothes (Tank Top) */
  "i_c_soldier_bandit_5_f": "U_I_C_Soldier_Bandit_5_F",
  /** Syndikat Uniform */
  "i_c_soldier_camo_f": "U_I_C_Soldier_Camo_F",
  /** Paramilitary Garb (Tee) */
  "i_c_soldier_para_1_f": "U_I_C_Soldier_Para_1_F",
  /** Paramilitary Garb (Jacket) */
  "i_c_soldier_para_2_f": "U_I_C_Soldier_Para_2_F",
  /** Paramilitary Garb (Shirt) */
  "i_c_soldier_para_3_f": "U_I_C_Soldier_Para_3_F",
  /** Paramilitary Garb (Tank Top) */
  "i_c_soldier_para_4_f": "U_I_C_Soldier_Para_4_F",
  /** Paramilitary Garb (Shorts) */
  "i_c_soldier_para_5_f": "U_I_C_Soldier_Para_5_F",
  /** CBRN Suit [AAF] */
  "i_cbrn_suit_01_aaf_f": "U_I_CBRN_Suit_01_AAF_F",
  /** Combat Fatigues [AAF] */
  "i_combatuniform": "U_I_CombatUniform",
  /** Combat Fatigues [AAF] (Rolled-up) */
  "i_combatuniform_shortsleeve": "U_I_CombatUniform_shortsleeve",
  /** Combat Fatigues [AAF] (Officer) */
  "i_combatuniform_tshirt": "U_I_CombatUniform_tshirt",
  /** CBRN Suit [LDF] */
  "i_e_cbrn_suit_01_eaf_f": "U_I_E_CBRN_Suit_01_EAF_F",
  /** Parade Uniform (Decorated) [LDF] */
  "i_e_paradeuniform_01_ldf_decorated_f": "U_I_E_ParadeUniform_01_LDF_decorated_F",
  /** Parade Uniform [LDF] */
  "i_e_paradeuniform_01_ldf_f": "U_I_E_ParadeUniform_01_LDF_F",
  /** Heli Pilot Coveralls [LDF] */
  "i_e_uniform_01_coveralls_f": "U_I_E_Uniform_01_coveralls_F",
  /** Combat Fatigues [LDF] */
  "i_e_uniform_01_f": "U_I_E_Uniform_01_F",
  /** Combat Fatigues (Officer) [LDF] */
  "i_e_uniform_01_officer_f": "U_I_E_Uniform_01_officer_F",
  /** Combat Fatigues (Rolled-up) [LDF] */
  "i_e_uniform_01_shortsleeve_f": "U_I_E_Uniform_01_shortsleeve_F",
  /** Combat Fatigues (Sweater) [LDF] */
  "i_e_uniform_01_sweater_f": "U_I_E_Uniform_01_sweater_F",
  /** Combat Fatigues (Tank Top) [LDF] */
  "i_e_uniform_01_tanktop_f": "U_I_E_Uniform_01_tanktop_F",
  /** Full Ghillie (Arid) [AAF] */
  "i_fullghillie_ard": "U_I_FullGhillie_ard",
  /** Full Ghillie (Lush) [AAF] */
  "i_fullghillie_lsh": "U_I_FullGhillie_lsh",
  /** Full Ghillie (Semi-Arid) [AAF] */
  "i_fullghillie_sard": "U_I_FullGhillie_sard",
  /** Combat Fatigues (Stavrou) */
  "i_g_resistanceleader_f": "U_I_G_resistanceLeader_F",
  /** Worn Combat Fatigues (Kerry) */
  "i_g_story_protagonist_f": "U_I_G_Story_Protagonist_F",
  /** Ghillie Suit [AAF] */
  "i_ghilliesuit": "U_I_GhillieSuit",
  /** Heli Pilot Coveralls [AAF] */
  "i_helipilotcoveralls": "U_I_HeliPilotCoveralls",
  /** Deserter Clothes (Jacket) */
  "i_l_uniform_01_camo_f": "U_I_L_Uniform_01_camo_F",
  /** Deserter Clothes (T-Shirt) */
  "i_l_uniform_01_deserter_f": "U_I_L_Uniform_01_deserter_F",
  /** Looter Clothes (T-Shirt, Black) */
  "i_l_uniform_01_tshirt_black_f": "U_I_L_Uniform_01_tshirt_black_F",
  /** Looter Clothes (T-Shirt, Olive) */
  "i_l_uniform_01_tshirt_olive_f": "U_I_L_Uniform_01_tshirt_olive_F",
  /** Looter Clothes (T-Shirt, Skull) */
  "i_l_uniform_01_tshirt_skull_f": "U_I_L_Uniform_01_tshirt_skull_F",
  /** Looter Clothes (T-Shirt, Sport) */
  "i_l_uniform_01_tshirt_sport_f": "U_I_L_Uniform_01_tshirt_sport_F",
  /** Combat Fatigues [AAF] (Officer) */
  "i_officeruniform": "U_I_OfficerUniform",
  /** Parade Uniform (Decorated) [AAF] */
  "i_paradeuniform_01_aaf_decorated_f": "U_I_ParadeUniform_01_AAF_decorated_F",
  /** Parade Uniform [AAF] */
  "i_paradeuniform_01_aaf_f": "U_I_ParadeUniform_01_AAF_F",
  /** Pilot Coveralls [AAF] */
  "i_pilotcoveralls": "U_I_pilotCoveralls",
  /** VR Suit [AAF] */
  "i_protagonist_vr": "U_I_Protagonist_VR",
  /** VR Entity Suit */
  "i_soldier_vr": "U_I_Soldier_VR",
  /** Wetsuit [AAF] */
  "i_wetsuit": "U_I_Wetsuit",
  /** Guerilla Garment */
  "ig_guerilla1_1": "U_IG_Guerilla1_1",
  /** Guerilla Outfit (Plain, Dark) */
  "ig_guerilla2_1": "U_IG_Guerilla2_1",
  /** Guerilla Outfit (Pattern) */
  "ig_guerilla2_2": "U_IG_Guerilla2_2",
  /** Guerilla Outfit (Plain, Light) */
  "ig_guerilla2_3": "U_IG_Guerilla2_3",
  /** Guerilla Smocks */
  "ig_guerilla3_1": "U_IG_Guerilla3_1",
  /** Guerilla Smocks 1 */
  "ig_guerilla3_2": "U_IG_Guerilla3_2",
  /** Guerilla Apparel */
  "ig_guerrilla_6_1": "U_IG_Guerrilla_6_1",
  /** Guerilla Uniform */
  "ig_leader": "U_IG_leader",
  /** Kabeiroi Leader's Outfit */
  "ig_menelaos": "U_IG_Menelaos",
  /** Combat Fatigues (Kerry) */
  "kerrybody": "U_KerryBody",
  /** Marshal Clothes */
  "marshal": "U_Marshal",
  /** Combat Fatigues (Miller) */
  "millerbody": "U_MillerBody",
  /** Underwear 1 */
  "nikosagedbody": "U_NikosAgedBody",
  /** Nikos Clothes */
  "nikosbody": "U_NikosBody",
  /** Fatigues (Hex) [CSAT] */
  "o_combatuniform_ocamo": "U_O_CombatUniform_ocamo",
  /** Fatigues (Urban) [CSAT] */
  "o_combatuniform_oucamo": "U_O_CombatUniform_oucamo",
  /** Full Ghillie (Arid) [CSAT] */
  "o_fullghillie_ard": "U_O_FullGhillie_ard",
  /** Full Ghillie (Lush) [CSAT] */
  "o_fullghillie_lsh": "U_O_FullGhillie_lsh",
  /** Full Ghillie (Semi-Arid) [CSAT] */
  "o_fullghillie_sard": "U_O_FullGhillie_sard",
  /** Gendarmerie Commander Uniform */
  "o_gen_commander_f": "U_O_GEN_Commander_F",
  /** Gendarmerie Uniform */
  "o_gen_soldier_f": "U_O_GEN_Soldier_F",
  /** Ghillie Suit [CSAT] */
  "o_ghilliesuit": "U_O_GhillieSuit",
  /** Light Fatigues (Hex) */
  "o_officer_noinsignia_hex_f": "U_O_officer_noInsignia_hex_F",
  /** Officer Fatigues (Hex) */
  "o_officeruniform_ocamo": "U_O_OfficerUniform_ocamo",
  /** Parade Uniform (Decorated) [CSAT] */
  "o_paradeuniform_01_csat_decorated_f": "U_O_ParadeUniform_01_CSAT_decorated_F",
  /** Parade Uniform [CSAT] */
  "o_paradeuniform_01_csat_f": "U_O_ParadeUniform_01_CSAT_F",
  /** Pilot Coveralls [CSAT] */
  "o_pilotcoveralls": "U_O_PilotCoveralls",
  /** VR Suit [CSAT] */
  "o_protagonist_vr": "U_O_Protagonist_VR",
  /** Tracksuit (Black) */
  "o_r_gorka_01_black_f": "U_O_R_Gorka_01_black_F",
  /** Granit-B Suit (Weathered) */
  "o_r_gorka_01_brown_f": "U_O_R_Gorka_01_brown_F",
  /** Granit-T Suit */
  "o_r_gorka_01_camo_f": "U_O_R_Gorka_01_camo_F",
  /** Granit-B Suit */
  "o_r_gorka_01_f": "U_O_R_Gorka_01_F",
  /** VR Entity Suit */
  "o_soldier_vr": "U_O_Soldier_VR",
  /** Recon Fatigues (Black) */
  "o_specopsuniform_blk": "U_O_SpecopsUniform_blk",
  /** Recon Fatigues (Hex) */
  "o_specopsuniform_ocamo": "U_O_SpecopsUniform_ocamo",
  /** Full Ghillie (Jungle) [CSAT] */
  "o_t_fullghillie_tna_f": "U_O_T_FullGhillie_tna_F",
  /** Officer Fatigues (Green Hex) [CSAT] */
  "o_t_officer_f": "U_O_T_Officer_F",
  /** Ghillie Suit (Green Hex) [CSAT] */
  "o_t_sniper_f": "U_O_T_Sniper_F",
  /** Fatigues (Green Hex) [CSAT] */
  "o_t_soldier_f": "U_O_T_Soldier_F",
  /** Special Purpose Suit (Green Hex) */
  "o_v_soldier_viper_f": "U_O_V_Soldier_Viper_F",
  /** Special Purpose Suit (Hex) */
  "o_v_soldier_viper_hex_f": "U_O_V_Soldier_Viper_hex_F",
  /** Wetsuit [CSAT] */
  "o_wetsuit": "U_O_Wetsuit",
  /** Guerilla Garment */
  "og_guerilla1_1": "U_OG_Guerilla1_1",
  /** Guerilla Outfit (Plain, Dark) */
  "og_guerilla2_1": "U_OG_Guerilla2_1",
  /** Guerilla Outfit (Pattern) */
  "og_guerilla2_2": "U_OG_Guerilla2_2",
  /** Guerilla Outfit (Plain, Light) */
  "og_guerilla2_3": "U_OG_Guerilla2_3",
  /** Guerilla Smocks */
  "og_guerilla3_1": "U_OG_Guerilla3_1",
  /** Guerilla Smocks 1 */
  "og_guerilla3_2": "U_OG_Guerilla3_2",
  /** Guerilla Apparel */
  "og_guerrilla_6_1": "U_OG_Guerrilla_6_1",
  /** Guerilla Uniform */
  "og_leader": "U_OG_leader",
  /** Scientist Suit */
  "oi_scientist": "U_OI_Scientist",
  /** Jacket and Shorts */
  "orestesbody": "U_OrestesBody",
  /** Rangemaster Suit */
  "rangemaster": "U_Rangemaster",
  /** Tanker Coveralls [AAF] */
  "tank_green_f": "U_Tank_green_F",
  /** Invisible Uniform */
  "virtualman_f": "U_VirtualMan_F",
} as const;
export type UniformClassName = typeof uniforms[keyof typeof uniforms];

export const vests = {
  /** Slash Bandolier (Black) */
  "bandollierb_blk": "V_BandollierB_blk",
  /** Slash Bandolier (Coyote) */
  "bandollierb_cbr": "V_BandollierB_cbr",
  /** Slash Bandolier (Green Hex) */
  "bandollierb_ghex_f": "V_BandollierB_ghex_F",
  /** Slash Bandolier (Khaki) */
  "bandollierb_khk": "V_BandollierB_khk",
  /** Slash Bandolier (Olive) */
  "bandollierb_oli": "V_BandollierB_oli",
  /** Slash Bandolier (Green) */
  "bandollierb_rgr": "V_BandollierB_rgr",
  /** Modular Carrier Vest (Geometric) */
  "carrierrigkbt_01_eaf_f": "V_CarrierRigKBT_01_EAF_F",
  /** Modular Carrier GL Rig (Geometric) */
  "carrierrigkbt_01_heavy_eaf_f": "V_CarrierRigKBT_01_heavy_EAF_F",
  /** Modular Carrier GL Rig (Olive) */
  "carrierrigkbt_01_heavy_olive_f": "V_CarrierRigKBT_01_heavy_Olive_F",
  /** Modular Carrier Lite (Geometric) */
  "carrierrigkbt_01_light_eaf_f": "V_CarrierRigKBT_01_light_EAF_F",
  /** Modular Carrier Lite (Olive) */
  "carrierrigkbt_01_light_olive_f": "V_CarrierRigKBT_01_light_Olive_F",
  /** Modular Carrier Vest (Olive) */
  "carrierrigkbt_01_olive_f": "V_CarrierRigKBT_01_Olive_F",
  /** Chest Rig (Black) */
  "chestrig_blk": "V_Chestrig_blk",
  /** Chest Rig (Khaki) */
  "chestrig_khk": "V_Chestrig_khk",
  /** Chest Rig (Olive) */
  "chestrig_oli": "V_Chestrig_oli",
  /** Chest Rig (Green) */
  "chestrig_rgr": "V_Chestrig_rgr",
  /** Deck Crew Vest (Blue) */
  "deckcrew_blue_f": "V_DeckCrew_blue_F",
  /** Deck Crew Vest (Brown) */
  "deckcrew_brown_f": "V_DeckCrew_brown_F",
  /** Deck Crew Vest (Green) */
  "deckcrew_green_f": "V_DeckCrew_green_F",
  /** Deck Crew Vest (Red) */
  "deckcrew_red_f": "V_DeckCrew_red_F",
  /** Deck Crew Vest (Violet) */
  "deckcrew_violet_f": "V_DeckCrew_violet_F",
  /** Deck Crew Vest (White) */
  "deckcrew_white_f": "V_DeckCrew_white_F",
  /** Deck Crew Vest (Yellow) */
  "deckcrew_yellow_f": "V_DeckCrew_yellow_F",
  /** EOD Vest (Blue) */
  "eod_blue_f": "V_EOD_blue_F",
  /** EOD Vest (Coyote) */
  "eod_coyote_f": "V_EOD_coyote_F",
  /** EOD Vest (Blue) [IDAP] */
  "eod_idap_blue_f": "V_EOD_IDAP_blue_F",
  /** EOD Vest (Olive) */
  "eod_olive_f": "V_EOD_olive_F",
  /** LBV Harness */
  "harnesso_brn": "V_HarnessO_brn",
  /** LBV Harness (Green Hex) */
  "harnesso_ghex_f": "V_HarnessO_ghex_F",
  /** LBV Harness (Grey) */
  "harnesso_gry": "V_HarnessO_gry",
  /** LBV Grenadier Harness */
  "harnessogl_brn": "V_HarnessOGL_brn",
  /** LBV Grenadier Harness (Green Hex) */
  "harnessogl_ghex_f": "V_HarnessOGL_ghex_F",
  /** LBV Grenadier Harness (Grey) */
  "harnessogl_gry": "V_HarnessOGL_gry",
  /** ELBV Harness */
  "harnessospec_brn": "V_HarnessOSpec_brn",
  /** ELBV Harness (Grey) */
  "harnessospec_gry": "V_HarnessOSpec_gry",
  /** Tactical Vest (Stavrou) */
  "i_g_resistanceleader_f": "V_I_G_resistanceLeader_F",
  /** Leg Strap Bag (Black) */
  "legstrapbag_black_f": "V_LegStrapBag_black_F",
  /** Leg Strap Bag (Coyote) */
  "legstrapbag_coyote_f": "V_LegStrapBag_coyote_F",
  /** Leg Strap Bag (Olive) */
  "legstrapbag_olive_f": "V_LegStrapBag_olive_F",
  /** Identification Vest (Red Crystal) */
  "plain_crystal_f": "V_Plain_crystal_F",
  /** Identification Vest [IDAP] */
  "plain_medical_f": "V_Plain_medical_F",
  /** US Plate Carrier Rig (Kerry) */
  "platecarrier_kerry": "V_PlateCarrier_Kerry",
  /** Carrier Lite (Black) */
  "platecarrier1_blk": "V_PlateCarrier1_blk",
  /** Carrier Lite (Green) */
  "platecarrier1_rgr": "V_PlateCarrier1_rgr",
  /** Carrier Lite (Green, No Flag) */
  "platecarrier1_rgr_noflag_f": "V_PlateCarrier1_rgr_noflag_F",
  /** Carrier Lite (Tropic) */
  "platecarrier1_tna_f": "V_PlateCarrier1_tna_F",
  /** Carrier Lite (Woodland) */
  "platecarrier1_wdl": "V_PlateCarrier1_wdl",
  /** Carrier Rig (Black) */
  "platecarrier2_blk": "V_PlateCarrier2_blk",
  /** Carrier Rig (Green) */
  "platecarrier2_rgr": "V_PlateCarrier2_rgr",
  /** Carrier Rig (Green, No Flag) */
  "platecarrier2_rgr_noflag_f": "V_PlateCarrier2_rgr_noflag_F",
  /** Carrier Rig (Tropic) */
  "platecarrier2_tna_f": "V_PlateCarrier2_tna_F",
  /** Carrier Rig (Woodland) */
  "platecarrier2_wdl": "V_PlateCarrier2_wdl",
  /** Carrier Rig (Green) */
  "platecarrier3_rgr": "V_PlateCarrier3_rgr",
  /** Carrier GL Rig (Black) */
  "platecarriergl_blk": "V_PlateCarrierGL_blk",
  /** Carrier GL Rig (MTP) */
  "platecarriergl_mtp": "V_PlateCarrierGL_mtp",
  /** Carrier GL Rig (Green) */
  "platecarriergl_rgr": "V_PlateCarrierGL_rgr",
  /** Carrier GL Rig (Tropic) */
  "platecarriergl_tna_f": "V_PlateCarrierGL_tna_F",
  /** Carrier GL Rig (Woodland) */
  "platecarriergl_wdl": "V_PlateCarrierGL_wdl",
  /** CTRG Plate Carrier Rig Mk.2 (Heavy) */
  "platecarrierh_ctrg": "V_PlateCarrierH_CTRG",
  /** GA Carrier Lite (Digital) */
  "platecarrieria1_dgtl": "V_PlateCarrierIA1_dgtl",
  /** GA Carrier Rig (Digital) */
  "platecarrieria2_dgtl": "V_PlateCarrierIA2_dgtl",
  /** GA Carrier GL Rig (Digital) */
  "platecarrieriagl_dgtl": "V_PlateCarrierIAGL_dgtl",
  /** GA Carrier GL Rig (Olive) */
  "platecarrieriagl_oli": "V_PlateCarrierIAGL_oli",
  /** CTRG Plate Carrier Rig Mk.1 (Light) */
  "platecarrierl_ctrg": "V_PlateCarrierL_CTRG",
  /** Carrier Special Rig (Black) */
  "platecarrierspec_blk": "V_PlateCarrierSpec_blk",
  /** Carrier Special Rig (MTP) */
  "platecarrierspec_mtp": "V_PlateCarrierSpec_mtp",
  /** Carrier Special Rig (Green) */
  "platecarrierspec_rgr": "V_PlateCarrierSpec_rgr",
  /** Carrier Special Rig (Tropic) */
  "platecarrierspec_tna_f": "V_PlateCarrierSpec_tna_F",
  /** Carrier Special Rig (Woodland) */
  "platecarrierspec_wdl": "V_PlateCarrierSpec_wdl",
  /** Multi-Pocket Vest (Black) */
  "pocketed_black_f": "V_Pocketed_black_F",
  /** Multi-Pocket Vest (Coyote) */
  "pocketed_coyote_f": "V_Pocketed_coyote_F",
  /** Multi-Pocket Vest (Olive) */
  "pocketed_olive_f": "V_Pocketed_olive_F",
  /** Vest (Press) */
  "press_f": "V_Press_F",
  /** Rangemaster Belt */
  "rangemaster_belt": "V_Rangemaster_belt",
  /** Rebreather [NATO] */
  "rebreatherb": "V_RebreatherB",
  /** Rebreather [AAF] */
  "rebreatheria": "V_RebreatherIA",
  /** Rebreather [CSAT] */
  "rebreatherir": "V_RebreatherIR",
  /** Safety Vest (Blue) */
  "safety_blue_f": "V_Safety_blue_F",
  /** Safety Vest (Orange) */
  "safety_orange_f": "V_Safety_orange_F",
  /** Safety Vest (Yellow) */
  "safety_yellow_f": "V_Safety_yellow_F",
  /** Kipchak Vest */
  "smershvest_01_f": "V_SmershVest_01_F",
  /** Kipchak Vest (Tactical Radio) */
  "smershvest_01_radio_f": "V_SmershVest_01_radio_F",
  /** Tactical Chest Rig (Coyote) */
  "tacchestrig_cbr_f": "V_TacChestrig_cbr_F",
  /** Tactical Chest Rig (Green) */
  "tacchestrig_grn_f": "V_TacChestrig_grn_F",
  /** Tactical Chest Rig (Olive) */
  "tacchestrig_oli_f": "V_TacChestrig_oli_F",
  /** Tactical Vest (Black) */
  "tacvest_blk": "V_TacVest_blk",
  /** Tactical Vest (Police) */
  "tacvest_blk_police": "V_TacVest_blk_POLICE",
  /** Tactical Vest (Brown) */
  "tacvest_brn": "V_TacVest_brn",
  /** Tactical Vest (Camo) */
  "tacvest_camo": "V_TacVest_camo",
  /** Gendarmerie Vest */
  "tacvest_gen_f": "V_TacVest_gen_F",
  /** Tactical Vest (Khaki) */
  "tacvest_khk": "V_TacVest_khk",
  /** Tactical Vest (Olive) */
  "tacvest_oli": "V_TacVest_oli",
  /** Camouflaged Vest */
  "tacvestcamo_khk": "V_TacVestCamo_khk",
  /** Raven Vest */
  "tacvestir_blk": "V_TacVestIR_blk",
} as const;
