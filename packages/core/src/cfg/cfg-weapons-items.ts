...
export const railItems = {
  "acc_esd_01_flashlight": "acc_esd_01_flashlight",
  "acc_flashlight": "acc_flashlight",
  "acc_flashlight_pistol": "acc_flashlight_pistol",
  "acc_flashlight_smg_01": "acc_flashlight_smg_01",
  "acc_pointer_ir": "acc_pointer_IR",
} as const;
export type RailItemClassName = typeof railItems[keyof typeof railItems];

export const bipods = {
  "bipod_01_f_blk": "bipod_01_F_blk",
  "bipod_01_f_khk": "bipod_01_F_khk",
  "bipod_01_f_mtp": "bipod_01_F_mtp",
  "bipod_01_f_snd": "bipod_01_F_snd",
  "bipod_02_f_arid": "bipod_02_F_arid",
  "bipod_02_f_blk": "bipod_02_F_blk",
  "bipod_02_f_hex": "bipod_02_F_hex",
  "bipod_02_f_lush": "bipod_02_F_lush",
  "bipod_02_f_tan": "bipod_02_F_tan",
  "bipod_03_f_blk": "bipod_03_F_blk",
  "bipod_03_f_oli": "bipod_03_F_oli",
} as const;
export type BipodClassName = typeof bipods[keyof typeof bipods];

export const muzzles = {
  "muzzle_antenna_01_f": "muzzle_antenna_01_f",
  "muzzle_antenna_02_f": "muzzle_antenna_02_f",
  "muzzle_antenna_03_f": "muzzle_antenna_03_f",
  "muzzle_antenna_test_01": "muzzle_antenna_test_01",
  "muzzle_snds_338_black": "muzzle_snds_338_black",
  "muzzle_snds_338_green": "muzzle_snds_338_green",
  "muzzle_snds_338_sand": "muzzle_snds_338_sand",
  "muzzle_snds_570": "muzzle_snds_570",
  "muzzle_snds_58_blk_f": "muzzle_snds_58_blk_F",
  "muzzle_snds_58_ghex_f": "muzzle_snds_58_ghex_F",
  "muzzle_snds_58_hex_f": "muzzle_snds_58_hex_F",
  "muzzle_snds_58_wdm_f": "muzzle_snds_58_wdm_F",
  "muzzle_snds_65_ti_blk_f": "muzzle_snds_65_TI_blk_F",
  "muzzle_snds_65_ti_ghex_f": "muzzle_snds_65_TI_ghex_F",
  "muzzle_snds_65_ti_hex_f": "muzzle_snds_65_TI_hex_F",
  "muzzle_snds_93mmg": "muzzle_snds_93mmg",
  "muzzle_snds_93mmg_tan": "muzzle_snds_93mmg_tan",
  "muzzle_snds_b": "muzzle_snds_B",
  "muzzle_snds_b_arid_f": "muzzle_snds_B_arid_F",
  "muzzle_snds_b_khk_f": "muzzle_snds_B_khk_F",
  "muzzle_snds_b_lush_f": "muzzle_snds_B_lush_F",
  "muzzle_snds_b_snd_f": "muzzle_snds_B_snd_F",
  "muzzle_snds_h": "muzzle_snds_H",
  "muzzle_snds_h_mg": "muzzle_snds_H_MG",
  "muzzle_snds_h_mg_blk_f": "muzzle_snds_H_MG_blk_F",
  "muzzle_snds_h_mg_khk_f": "muzzle_snds_H_MG_khk_F",
  "muzzle_snds_h_sw": "muzzle_snds_H_SW",
  "muzzle_snds_h_khk_f": "muzzle_snds_H_khk_F",
  "muzzle_snds_h_snd_f": "muzzle_snds_H_snd_F",
  "muzzle_snds_l": "muzzle_snds_L",
  "muzzle_snds_m": "muzzle_snds_M",
  "muzzle_snds_acp": "muzzle_snds_acp",
  "muzzle_snds_m_khk_f": "muzzle_snds_m_khk_F",
  "muzzle_snds_m_snd_f": "muzzle_snds_m_snd_F",
  "muzzle_tma_65": "muzzle_tma_65",
} as const;
export type MuzzleClassName = typeof muzzles[keyof typeof muzzles];

export const optics = {
  "optic_aco_grn": "optic_ACO_grn",
  "optic_aco_grn_smg": "optic_ACO_grn_smg",
  "optic_ams": "optic_AMS",
  "optic_ams_khk": "optic_AMS_khk",
  "optic_ams_snd": "optic_AMS_snd",
  "optic_aco": "optic_Aco",
  "optic_aco_smg": "optic_Aco_smg",
  "optic_arco": "optic_Arco",
  "optic_arco_ak_arid_f": "optic_Arco_AK_arid_F",
  "optic_arco_ak_blk_f": "optic_Arco_AK_blk_F",
  "optic_arco_ak_lush_f": "optic_Arco_AK_lush_F",
  "optic_arco_arid_f": "optic_Arco_arid_F",
  "optic_arco_blk_f": "optic_Arco_blk_F",
  "optic_arco_ghex_f": "optic_Arco_ghex_F",
  "optic_arco_lush_f": "optic_Arco_lush_F",
  "optic_dms": "optic_DMS",
  "optic_dms_ghex_f": "optic_DMS_ghex_F",
  "optic_dms_weathered_f": "optic_DMS_weathered_F",
  "optic_dms_weathered_kir_f": "optic_DMS_weathered_Kir_F",
  "optic_erco_blk_f": "optic_ERCO_blk_F",
  "optic_erco_khk_f": "optic_ERCO_khk_F",
  "optic_erco_snd_f": "optic_ERCO_snd_F",
  "optic_hamr": "optic_Hamr",
  "optic_hamr_khk_f": "optic_Hamr_khk_F",
  "optic_holosight": "optic_Holosight",
  "optic_holosight_arid_f": "optic_Holosight_arid_F",
  "optic_holosight_blk_f": "optic_Holosight_blk_F",
  "optic_holosight_khk_f": "optic_Holosight_khk_F",
  "optic_holosight_lush_f": "optic_Holosight_lush_F",
  "optic_holosight_smg": "optic_Holosight_smg",
  "optic_holosight_smg_blk_f": "optic_Holosight_smg_blk_F",
  "optic_holosight_smg_khk_f": "optic_Holosight_smg_khk_F",
  "optic_khs_blk": "optic_KHS_blk",
  "optic_khs_hex": "optic_KHS_hex",
  "optic_khs_old": "optic_KHS_old",
  "optic_khs_tan": "optic_KHS_tan",
  "optic_lrps": "optic_LRPS",
  "optic_lrps_ghex_f": "optic_LRPS_ghex_F",
  "optic_lrps_tna_f": "optic_LRPS_tna_F",
  "optic_mrco": "optic_MRCO",
  "optic_mrd": "optic_MRD",
  "optic_mrd_black": "optic_MRD_black",
  "optic_nvs": "optic_NVS",
  "optic_nightstalker": "optic_Nightstalker",
  "optic_sos": "optic_SOS",
  "optic_sos_khk_f": "optic_SOS_khk_F",
  "optic_yorris": "optic_Yorris",
  "optic_ico_01_black_f": "optic_ico_01_black_f",
  "optic_ico_01_camo_f": "optic_ico_01_camo_f",
  "optic_ico_01_f": "optic_ico_01_f",
  "optic_ico_01_sand_f": "optic_ico_01_sand_f",
  "optic_tws": "optic_tws",
