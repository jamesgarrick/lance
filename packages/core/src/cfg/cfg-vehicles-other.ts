...
export const cfgVehiclesOther = {
	...
	land: {
		...
		signm: {
			 ...
			 * - Subcategory: Warnings
			 */
			warningmilitaryvehicles_english:
...
export type CfgVehiclesOther = typeof cfgVehiclesOther;
