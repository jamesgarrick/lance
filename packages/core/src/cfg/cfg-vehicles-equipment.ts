...
export const cfgVehiclesEquipment = {
	...
	item: {
		...
		u: {
			 ...
			 * - Subcategory: Uniforms
			 */
			b_combatuniform_tshirt_mcam_wdl:
			 ...
			 * - Subcategory: Uniforms
			 */
			b_paradeuniform_01_us_decorated:
			 ...
			 * - Subcategory: Uniforms
			 */
			o_paradeuniform_01_csat_decorated:
			 ...
			 * - Subcategory: Uniforms
			 */
			i_paradeuniform_01_aaf_decorated:
			 ...
			 * - Subcategory: Uniforms
			 */
			i_e_paradeuniform_01_ldf_decorated:
	...
	land: {
		...
		pod: {
			 ...
			 * - Subcategory: Storage
			 */
			heli_transport_04_repair_black:
