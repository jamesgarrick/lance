...
const datasetOptions = {
	...
	cfgWeaponsItems: {
		subsetExports: [
			{
				constName: "railItems",
				typeName: "RailItemClassName",
				sourceKey: "acc",
				stripPrefix: "acc_",
			},
			{
				constName: "bipods",
				typeName: "BipodClassName",
				sourceKey: "bipod",
				stripPrefix: "bipod_",
			},
			{
				constName: "muzzles",
				typeName: "MuzzleClassName",
				sourceKey: "muzzle",
				stripPrefix: "muzzle_",
			},
			{
				constName: "optics",
				typeName: "OpticClassName",
				sourceKey: "optic",
				stripPrefix: "optic_",
			},
		],
	...
	cfgWeaponsEquipment: {
		subsetExports: [
			{
				constName: "headgear",
				typeName: "HeadgearClassName",
				sourceKey: "h",
				stripPrefix: "H_",
			},
			{
				constName: "uniforms",
				typeName: "UniformClassName",
				sourceKey: "u",
				stripPrefix: "U_",
			},
			{
				constName: "vests",
				typeName: "VestClassName",
				sourceKey: "v",
				stripPrefix: "V_",
			},
		],
	...
	cfgVehiclesStructures: {
		subsetExports: [
			{ constName: "structures", typeName: "StructureClassName" },
		],
	},
};
	...
	return options.subsetExports
		.map(({ constName, typeName, sourceKey, stripPrefix }) => {
			...
			if (sourceKey && !(sourceKey in json)) {
				throw new Error(
					`Missing subset source key "${sourceKey}" in dataset "${exportName}"`,
				);
			}
