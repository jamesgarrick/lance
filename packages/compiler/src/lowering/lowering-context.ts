...
export interface LoweringDispatcher {
  readonly lowerExpression: (expression: Expression, context: LoweringContext) => SqfExpression;
  readonly lowerStatement: (statement: Statement, context: LoweringContext) => SqfStatement;
  readonly lowerStatementBlock: (statement: Statement, context: LoweringContext) => readonly SqfStatement[];
}
