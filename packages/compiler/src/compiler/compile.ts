...
import {
	LANCE_RUNTIME_FILES,
	LANCE_RUNTIME_FUNCTION_FILES,
} from "../runtime/lance-runtime";
...
): Promise<{ sqf: string; diagnostics: readonly CompilerDiagnostic[] }> {
...
export async function compileFromConfig(
	...
	const options: CompilerOptions = {
		...
		typesPackageName:
			build.typesPackage ?? defaultCompilerOptions.typesPackageName,
